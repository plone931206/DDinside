...
public class DDinsideDAO {
	private DDinsideDAO() {} 
	private static DDinsideDAO instance = new DDinsideDAO();
	public static DDinsideDAO getInstance() {return instance;}
	...
	public List<BoardVO> selectAllBoard(int page, String board_id){
		...
		int endNum = page*10;
		BoardVO boardVO = null;
		String sql ="SELECT * FROM (SELECT T.*, ROW_NUMBER() OVER(ORDER BY writedate DESC) AS RNUM FROM DDinside T where board_id = ?) WHERE RNUM BETWEEN ? AND ?";
	...
	public List<BoardVO> selectNotice(String board_id) {
		BoardVO boardVO = null;
		String sql = "SELECT * FROM DDinside WHERE board_id = ?";
		List<BoardVO> list = new ArrayList<BoardVO>();
	...
	public int commentCount(String num, String board_id) {
		String sql = "select * from (select * from DDinside_comment order by writedate asc) where board_num = ? and board_id =? ";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public List<BoardVO> search(int page, SearchVO searchVO, String board_id) {
		int startNum = (page-1)*10+1;
		int endNum = page*10;
		//String sql = "select * from (select * from DDinside where title LIKE '%'||?||'%'  or content  LIKE '%'||?||'%') where board_id = ? order by writedate desc";
		String sql ="SELECT * FROM (SELECT T.*, ROW_NUMBER() OVER(ORDER BY writedate DESC) AS RNUM FROM DDinside T where board_id = ? and (title LIKE '%'||?||'%' or content  LIKE '%'||?||'%')) WHERE RNUM BETWEEN ? AND ?";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		BoardVO boardVO;
		...
		try {
			...
			pstmt.setString(1, board_id);
			pstmt.setString(2, searchVO.getKeyWord());
			pstmt.setString(3, searchVO.getKeyWord());
	...
	public List<BoardVO> mainNoticeBest() {
		String sql ="select * from DDinside where up >= 5";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		BoardVO boardVO;
	...
	public List<BoardVO> mainNoticeWorst() {
		String sql ="select * from DDinside where down >= 5";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		BoardVO boardVO;
	...
	public List<BoardVO> mainNoticeAho() {
		String sql ="select * from DDinside where aho >= 5";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		BoardVO boardVO;
