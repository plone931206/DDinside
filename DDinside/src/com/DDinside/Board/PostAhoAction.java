...
public class PostAhoAction implements Action{
	String board_id;
	public PostAhoAction(String board_id) {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(board_id.equals("高評価") || board_id.equals("低評価") || board_id.equals("アホ") || board_id.equals("統合")) {
			suv_boardDAO.postAhoCount(num, board_id); 
			countVO = suv_boardDAO.getPostCount(num, board_id);
		} else {
			boardDAO.postAhoCount(num, board_id); 
